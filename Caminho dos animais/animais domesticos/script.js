// --- DADOS ---
const animalsData = [
    { id: 'cat', name: 'Gato', animalImg: '🐱', objectImg: '🐟', successImg: '✅', bg: '#ffeaa7' },
    { id: 'dog', name: 'Cão', animalImg: '🐶', objectImg: '🦴', successImg: '✅', bg: '#fab1a0' },
    { id: 'bird', name: 'Pássaro', animalImg: '🐦', objectImg: '🐛', successImg: '✅', bg: '#ff7675' },
    { id: 'rabbit', name: 'Coelho', animalImg: '🐰', objectImg: '🥕', successImg: '✅', bg: '#fdcb6e' },
    { id: 'turtle', name: 'Tartaruga', animalImg: '🐢', objectImg: '🌿', successImg: '✅', bg: '#4d8f57ff' },
];
