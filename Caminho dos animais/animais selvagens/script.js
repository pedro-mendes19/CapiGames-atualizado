// --- DADOS ---
const animalsData = [
    { id: 'lion', name: 'Leão', animalImg: '🦁', objectImg: '🥩', successImg: '✅', bg: '#ffeaa7' },
    { id: 'monkey', name: 'Macaco', animalImg: '🐵', objectImg: '🍌', successImg: '✅', bg: '#fab1a0' },
    { id: 'koala', name: 'Coala', animalImg: '🐨', objectImg: '🎋', successImg: '✅', bg: '#ff7675' },
    { id: 'bear', name: 'Urso', animalImg: '🐻', objectImg: '🍯', successImg: '✅', bg: '#fdcb6e' },
    { id: 'penguin', name: 'Pinguim', animalImg: '🐧', objectImg: '🐟', successImg: '✅', bg: '#bdaef3ff' },
];
